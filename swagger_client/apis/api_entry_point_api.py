...
class APIEntryPointApi(object):
    ...
    def retrieve_api_resources(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.retrieve_api_resources(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.retrieve_api_resources_with_http_info(**kwargs)
        else:
            (data) = self.retrieve_api_resources_with_http_info(**kwargs)
            return data

    def retrieve_api_resources_with_http_info(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.retrieve_api_resources_with_http_info(callback=callback_function)
